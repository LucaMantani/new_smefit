...
- `plot_fits_posterior_contours(fits, params_to_plot=None, confidence_level=95, subplot_size=4, kde=None, double_solution=None, show_sm=True, show_best_fit=False, reference_points=None) -> 'Figure'`
  - Overlay the 2D marginalised confidence contours of every fit.
- `plot_posterior_contours(fit, params_to_plot=None, confidence_level=95, subplot_size=4, kde=None, double_solution=None, show_sm=True, show_best_fit=False, reference_points=None) -> 'Figure'`
